document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeof FullCalendar === 'undefined') {
        ...
        document.getElementById('result').innerHTML = 'Greška: Kalendar nije učitan. Provjerite internet ili datoteke.';
        return;
    }
    ...
    function initAutocomplete() {
        if (typeof google === 'undefined' || !google.maps || !google.maps.places) {
            ...
            document.getElementById('result').innerHTML = 'Greška: Google Places API nije dostupan. Provjerite internet ili konfiguraciju.';
            return;
        }
    ...
    form.addEventListener('submit', async function(event) {
        ...
        document.getElementById('result').innerHTML = 'Učitavanje...';
